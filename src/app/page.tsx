          ...
          <div className="py-16 max-sm:py-[105px]" id="about-me">
            ...
            <div className="flex justify-between gap-[80px] mt-8 max-[900px]:flex-col max-[900px]:gap-[40px] max-[900px]:justify-center max-[450px]:gap-10 max-[450px]:mt-4">
              <div className="w-2/4 max-[900px]:w-full">
                <p className="leading-6 text-lg">Ingeniero de Sistemas enfocado en el desarrollo web, enfocado en adquirir experiencia en el campo empresarial. Me considero una persona con gran capacidad para seguir instrucciones, con buena gestión del tiempo y excelentes habilidades de organización, disposición para el trabajo en equipo, paciente, abierto a nuevos aprendizajes y buena capacidad de concentración.</p>
              </div>

              <div className="max-w-[412px] w-full p-5 rounded-lg bg-[#1b1e1d] max-[900px]:m-auto max-[900px]:max-w-full">
                <h3 className="pb-4 text-xl font-medium">Tecnico Superior en Programación</h3>
                <p className="pb-5">Titulo de Tecnico Superior en Programación de la Corporación Universitaria Americana</p>
                <p className="text-sm">- Graduado el de [FECHA] 2024</p>
              </div>
            </div>
          </div>
